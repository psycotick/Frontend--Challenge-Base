                ...
                <div className="py-10 flex flex-col lg:flex-row items-center gap-5">
                    <div className="w-full lg:w-1/2 min-h-96 rounded-md overflow-hidden group">
                        <Image
                            ...
                            width={1920}
                            height={1080}
                            className="w-full h-full object-cover shadow-md shadow-yellow-900 drop-shadow-xl group-hover:scale-110 duration-500"
                        />
                    </div>
                    <div className="w-full lg:w-1/2 flex flex-col gap-2">
                        <h2 className="text-2xl font-semibold underline decoration-[1px] text-yellow-600">
                            {details?.original_title}
                        </h2>
                        <p className="text-sm leading-6 tracking-wide mt-2 text-white">
                            {details?.overview}
                        </p>
