        ...
        <div className="flex flex-col text-gray-300">
            {contact
                ? contactArray.map((item) => (
                    ...
                    >
                        <span className="w-2 h-2 rounded-full inline-flex border border-yellow-700 group-hover:bg-yellow-700 duration-200" />
                        {item?.title}
                    </Link>
                ))
                : infoArray.map((item) => (
        ...
        <div className="bg-[#191919] px-10 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div>
                <h2 className="text-base uppercase font-bold text-white tracking-wide border-b border-b-gray-600 py-2 mb-5 relative">
                    About us{" "}
                    <span className="w-16 h-1 bg-yellow-600 inline-block absolute left-0 -bottom-[1.5px] z-10" />
                </h2>
                <Logo />
            ...
            <div>
                ...
                <div className="text-gray-300 text-sm flex flex-col gap-2">
                    <p>
                        Phone: <span className="text-white font-medium">(+57) 3118011657</span>
                    </p>
                    <p>
                        Email:{" "}
                        <span className="text-white font-medium">
                            santiago.develops@gmail.com
                        </span>
                    </p>
                </div>
            </div>
